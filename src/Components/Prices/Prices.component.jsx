...
const getAllPrices = () => new Promise(async (resolve, reject) => {
    try {
        ...
        const { data } = await axios.get("https://ardent-medley-272823.appspot.com/collection/prices/minimal")
        ...
        Object.values(data).map(i => dataFill.push({ ...i, uri: i.symbol === "ALY" ? urlALY : `https://s2.coinmarketcap.com/static/img/coins/128x128/${i.id}.png` }))
